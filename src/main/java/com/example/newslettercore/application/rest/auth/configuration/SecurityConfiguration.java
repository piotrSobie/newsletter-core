        ...
        httpSecurity
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST_URL)
                                ...
                                .requestMatchers(GET, "/api/v1/subscription/**").hasAnyAuthority(ADMIN_READ.getPrivilege(), USER_READ.getPrivilege())
                                .requestMatchers(POST, "/api/v1/subscription/**").hasAnyAuthority(ADMIN_CREATE.getPrivilege(), USER_CREATE.getPrivilege())
                                .requestMatchers(DELETE, "/api/v1/subscription/**").hasAnyAuthority(ADMIN_DELETE.getPrivilege(), USER_DELETE.getPrivilege())
                                .anyRequest()
                                .authenticated()
                )
